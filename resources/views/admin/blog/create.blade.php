...
@section('content')
    ...
    <section class="content">
        ...
        <form id="projectForm" method="post" action="{{ route('admin.blog.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="card">
                <div class="card-body">								 
                    <div class="row">  
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" placeholder="Enter Title" value="{{ old('name') }}">
                                @error('name')
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="subtitle" id="subtitle"  class="form-control @error('subtitle') is-invalid @enderror" placeholder="Enter Subtitle" value="{{ old('subtitle') }}">
                                @error('subtitle')
                                    <p class="invalid-feedback">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="author" id="author"  class="form-control @error('author') is-invalid @enderror" placeholder="Enter Author Name" value="{{ old('author') }}">
                                @error('author')
                                    <p class="invalid-feedback">{{ $message }}</p>
                                @enderror
                            </div>
