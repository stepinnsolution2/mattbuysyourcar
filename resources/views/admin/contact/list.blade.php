            ...
            <table id="table" class="table table-sm table-striped">
                <thead style="background:green;color:white;">
                        <tr>
                            ...
                            <th class="text-left">Meaasage</th>
                    ...
                    <tbody>
                            @foreach($contacts as $index => $contact)
                                <tr>
                                    ...
                                    <td class="text-center align-middle" style="max-width: 150px;">{{ $contact->message }}</td>
                                    <td class="text-center align-middle">{{ $contact->created_at }}</td>
                                    <td class="text-center align-middle" >
                                        <a href="javascript:void(0)" onclick="deletecontact({{ $contact->id }})"  class="btn btn-danger btn-sm"> Delete
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status) {
                        ...
                        Swal.fire("Error", "There was a problem deleting the contact.", "error");
                    }
                },
